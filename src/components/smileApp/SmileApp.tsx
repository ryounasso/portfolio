...
import SmileAppModal from "./SmileAppModal";
    ...
    <Box display="flex" justifyContent="center" p={1}>
      <List className={classes.root}>
        <ListItem>
          ...
          <ListItemText
            primary="笑ってはいけない〇〇時 アプリ"
            secondary="カメラに写っているその人が笑っているかどうかを判定します。"
          />
          ...
          <Link href="https://smile-detection-app.vercel.app/" color="inherit">
            <Avatar className={classes.link}>
              <LinkIcon />
            </Avatar>
          </Link>
          <Box display="flex">
            <ListItemLink href="https://github.com/ryounasso/smile_app">
